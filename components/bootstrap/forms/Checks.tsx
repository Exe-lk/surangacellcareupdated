...
// 		// Only remove the highlight if the click is on the group background, not on a child (checkbox)
// 		if (e.currentTarget === e.target) {
// 		  setActiveCheckbox(null);
// 		}
// 	  };
  
// 	  const handleChildClick = (e: React.MouseEvent, id: string) => {
// 		e.stopPropagation(); // Prevent click event from bubbling to the parent
// 		// Toggle the active state only when clicking on a checkbox
// 		setActiveCheckbox((prev) => (prev === id ? null : id));
// 	  };
...
// 			className={classNames(
// 			  {
// 				'group-active': activeCheckbox !== null, // Add blue highlight when active
// 				'is-invalid': !isValid && isTouched && invalidFeedback,
// 				'is-valid': isValid && isTouched && !invalidFeedback,
// 			  },
// 			  className
// 			)}
// 			onClick={handleGroupClick} // Attach click handler to the group
// 			{...props}
// 		  >
// 			{Children.map(children, (child) =>
// 			  cloneElement(child, {
// 				onClick: (e: React.MouseEvent) => handleChildClick(e, child.props.id || ''),
// 				isInline: child.props.isInline || isInline,
// 				isValid,
// 				isTouched,
// 				invalidFeedback,
...
// 	  PropTypes.element as PropTypes.Validator<ReactElement<IChecksProps>>,
// 	  PropTypes.arrayOf(PropTypes.element as PropTypes.Validator<ReactElement<IChecksProps>>),
// 	]).isRequired,
// 	isInline: PropTypes.bool,
// 	isTouched: PropTypes.bool,
// 	isValid: PropTypes.bool,
